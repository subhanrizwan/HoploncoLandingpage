    ...
    <>
      ...
      >
        ...
        <div style={{ position: "relative", zIndex: 1 }}>
          ...
          <h2 className="text-black text-center max-w-[900px] w-full font-[300] text-[13px] mb-10">
...
<h2 className="text-black text-center max-w-[900px] w-full font-[300] text-[13px] mb-10">
  ...
  with any third-party brands unless explicitly stated.
            ...
            <h2 className="w-full text-center text-sm border-1 md:w-[600px] rounded-full p-2 text-white bg-black border-black">
