...
export default function BelowHeroSection() {
  ...
  return (
    <>
      <div class="h-52 md:h-36 lg:h-60 xl:h-96 relative w-full aspect-[16/9] bg-black">
        <img
          src={Shad}
          alt=""
          class="absolute md:-top-40 top-10 w-full z-0 pointer-events-none"
          style={{
            objectFit: "cover",
          }}
        />
      ...
      <section className="relative bg-gray-100 border-none overflow-hidden mt-0 mb-0 pb-0 ">
        ...
        <div className=" relative sm:pt-0 pt-20 pb-12 border-none px-4 bg-white">
