...
import FirstAnimatedButton from "./components/AnimatedBtn1";
// import SecondAnimatedButton from "./components/AnimatedBtn2";
import FocusOnSelect from "./components/Slider";
  ...
  return (
    <>
        ...
        >
          ...
          <ellipse cx={960} cy={120} rx={1000} ry={120} fill="url(#_R_clfdb_)" />
        </svg>
             <section className="bg-gradient-to-b from-[#333] to-[#fff]  flex flex-col items-center justify-center px-6 ">
               <div className="my-4">
               ...
               <h2 className="text-[#f0efef] text-center max-w-[800px] font-[300] text-[20px]">
